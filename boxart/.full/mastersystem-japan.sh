...
7z x -y -aoa /home/pi/test/mastersystem-japan_unified_rompack.7z
sudo mv mastersystem-japan /home/pi/RetroPie/roms
sudo rm "mastersystem-japan_unified_rompack.7z"
cd ..
sudo rm -R test
